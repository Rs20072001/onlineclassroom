...
<body>
    <a href="https://wa.me/919064787378" class="whatsapp_float" target="_blank"> <i class="fa fa-whatsapp whatsapp-icon"></i></a>
...
<?php include('allhead.php'); ?>
        ...
        <small>Your Own Classroom</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="col-md-6">
        <h2>ABOUT YOUR CLASSROOMS</h2>
        <p>The <strong>“Your Own Classroom”</strong> Website (web based application) is useful for the
...
In this application, student can attend his\her missed classes from e-learn.</p>
        ...
        <p class="footer text-center">Major Project 2022  <strong>BCA</strong> project Made by <strong>Rumpa Sadhu & Pratichi Sarkar</strong></p>
